...
export const CROSS_CUTTING = {
  ...
  themeConnection:
    '作品づくりは、答えを表現するためだけではなく、制作を通して考えを深めるための手段でもあります。診断メディアでは「分類」から自己を見つめ、AIと日記では対話を通して思考を観察し、アートアーカイブでは記録と編集によって場所の新たな価値を見出しました。' +
    '3つの演習は異なるテーマを扱いながらも、「つくりながら考える」という共通の実践を通して、観察・思考・表現を往復するプロセスを学びました。',
  note:
